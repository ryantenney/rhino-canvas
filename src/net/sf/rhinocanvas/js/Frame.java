...
/**
 * Applet or Frame. Should behave like document to some extent. The variable
 * document should initially point to a Frame instance.
 * 
...
public class Frame extends Component {
	...
	Frame(RootPaneContainer container, Object content) {
		...
		helper.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				if (helper.getWidth() != Frame.this.content.getWidth()
						|| helper.getHeight() != Frame.this.content.getHeight()) {

					BufferedImage newImage = new BufferedImage(helper
							.getWidth(), helper.getHeight(),
	...
	Frame(CanvasApplet applet) {
		this((RootPaneContainer) applet, new Image(applet.getWidth(),
				applet.getHeight()));
		this.applet = applet;
	}
	...
	public Object getElementById(String id) {
		RhinoRuntime runtime = (RhinoRuntime) Context.getCurrentContext()
				.getThreadLocal("runtime");
